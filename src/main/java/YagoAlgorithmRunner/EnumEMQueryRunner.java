...
import Infra.*;
import Util.YagoVF2PatternConverter;
...
public class EnumEMQueryRunner {
    ...
    private VF2SubgraphIsomorphismInspector<DataNode, RelationshipEdge> inspector;
    ...
    public EnumEMQueryRunner(QueriesDependencyGraph queryGraph, YagoOntologyGraph oGraph,
                             int alpha, YagoInduceGraphGenerator induceGraphs) {
    ...
    public void execute() {
        ...
        System.out.println(current - start + "ENUM Cost");
...
//            System.out.println("------------");
    ...
    private void getInitialMatches(OGKQuery currentQuery) {
        ...
        if (!currentQuery.isC) {
            ...
            currentQuery.getResultMatches().classifyResultSets();
            System.out.println(currentQuery.getRoot());
            System.out.println(currentQuery.getResultMatches().classSet.size() + " " + "initial matches.");
    ...
    private void ontologySearch(OGKQuery ogkQuery) {
        ...
        Graph<DataNode, RelationshipEdge> pattern = new
                YagoVF2PatternConverter(ogkQuery, oGraph, alpha).getPattern();
        ...
        System.out.println("Search Cost Time:" + (endTime - startTime));
        ...
        if (inspector.isomorphismExists()) {
            ...
            System.out.println("Current Matches :" + matches.size());
        } else {
