...
public class GKEMQueryRunner {
    ...
    public GKEMQueryRunner(QueriesDependencyGraph queryGraph,
                            DBPediaInduceGraphGenerator2 induceGraphs) {
    ...
    public void execute() {
        ...
        System.out.println("GKEM Time: " + (endTime - startTime));
    ...
    private void getInitialMatches(OGKQuery currentQuery) {
        ...
        if (!currentQuery.isC) {
            ...
            for (DataNode dataNode : induceGraph.vertexSet()) {
                ...
                if (dataNode.getTypes().contains(currentQuery.getRoot())) {
            ...
            for (DataNode node : induceGraph.vertexSet()) {
                if (node.getTypes().contains(currentQuery.getRoot())) {
