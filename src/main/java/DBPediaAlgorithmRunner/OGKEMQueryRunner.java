...
public class OGKEMQueryRunner {
    ...
    public OGKEMQueryRunner(QueriesDependencyGraph queryGraph, DBPediaDataGraph dataGraph,
                            DBPediaOntologyGraph oGraph, double theta, int alpha,
    ...
    private void pruneByTheta(OGKQuery currentQuery, double theta) {
        ...
        for (DataNode node : currentQuery.getResultMatches().classSet.keySet()) {
            ...
            if (currentCost > theta) {
                ...
                //System.out.print("Cost updated" + currentCost);
            }
